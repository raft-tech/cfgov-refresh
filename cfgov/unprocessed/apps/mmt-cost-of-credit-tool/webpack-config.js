const APP_NAME = 'mmt-cost-of-credit-tool';
...
//const SERVICE_WORKER_DESTINATION = '../../../../jinja2/v1/mmt-cost-of-credit-tool/service-worker.js';
...
const GENERATE_SERVICE_WORKER = new InjectManifest({
  swSrc: 'cfgov/unprocessed/apps/mmt-cost-of-credit-tool/js/sw.js',
      ...
      use: [
        {
          ...
          options: {
            publicPath: '/static/apps/mmt-cost-of-credit-tool/js/',
          },
        },
        'css-loader',
      ],
