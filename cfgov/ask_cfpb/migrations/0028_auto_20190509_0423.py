# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-05-09 08:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type', models.CharField(choices=[('basics', 'Basics'), ('common_issues', 'Common issues'), ('howto', 'How to'), ('know_your_rights', 'Know your rights')], max_length=20, verbose_name='Type')),
                ...
                ('sections', wagtail.wagtailcore.fields.StreamField([('section', wagtail.wagtailcore.blocks.StructBlock([('anchor', wagtail.wagtailcore.blocks.CharBlock(max_length=255)), ('heading', wagtail.wagtailcore.blocks.CharBlock(max_length=255)), ('summary', wagtail.wagtailcore.blocks.TextBlock(blank=True, required=False)), ('link', wagtail.wagtailcore.blocks.StructBlock([(b'text', wagtail.wagtailcore.blocks.CharBlock(required=False)), (b'url', wagtail.wagtailcore.blocks.CharBlock(default=b'/', required=False))])), ('subsection', wagtail.wagtailcore.blocks.ListBlock(wagtail.wagtailcore.blocks.StructBlock([('heading', wagtail.wagtailcore.blocks.CharBlock(blank=True, max_length=255, required=False)), ('summary', wagtail.wagtailcore.blocks.TextBlock(blank=True, required=False)), ('link', wagtail.wagtailcore.blocks.StructBlock([(b'text', wagtail.wagtailcore.blocks.CharBlock(required=False)), (b'url', wagtail.wagtailcore.blocks.CharBlock(default=b'/', required=False))]))])))]))])),
