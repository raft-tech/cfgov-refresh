# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-05-11 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sections', wagtail.wagtailcore.fields.StreamField([('section', wagtail.wagtailcore.blocks.StructBlock([('section_heading', wagtail.wagtailcore.blocks.CharBlock(max_length=255)), ('section_anchor', wagtail.wagtailcore.blocks.CharBlock(max_length=255)), ('section_links', wagtail.wagtailcore.blocks.ListBlock(wagtail.wagtailcore.blocks.StructBlock([('heading', wagtail.wagtailcore.blocks.CharBlock(blank=True, max_length=255, required=False)), ('summary', wagtail.wagtailcore.blocks.TextBlock(blank=True, required=False)), ('link', wagtail.wagtailcore.blocks.StructBlock([(b'text', wagtail.wagtailcore.blocks.CharBlock(required=False)), (b'url', wagtail.wagtailcore.blocks.CharBlock(default=b'/', required=False))]))])))]))])),
